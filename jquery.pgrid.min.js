...
d||c.children(":hidden").each(function(){var a=b(this).show();e.children(":nth-child("+(a.prevAll().length+1)+")").show()});var f=a.pgrid_header_select.children().children();f.attr("checked",true);for(var h in a.pgrid_hidden_cols)isNaN(h)||(f.filter(".ui-pgrid-table-col-hider-"+a.pgrid_hidden_cols[h]).removeAttr("checked"),c.children(":nth-child("+(a.pgrid_hidden_cols[h]+1)+")").hide(),e.children(":nth-child("+(a.pgrid_hidden_cols[h]+1)+")").hide());d||a.state_changed()};a.hide_col=function(b){a.pgrid_hidden_cols.indexOf(b)==
...
1)}).addClass("ui-pgrid-table-col-hider-"+(d+1))).append(e.text()))});a.pgrid_header_select.addClass("ui-pgrid-header-select ui-widget-header ui-corner-all");a.pgrid_header_select.mouseenter(function(){b(this).mouseleave(function(){b(this).fadeOut("fast").unbind("mouseleave")})});a.resizing_header=false;a.resizing_tempX=0;var g=b("<div />").addClass("ui-pgrid-table-header-text");a.pgrid_sortable&&g.addClass("ui-pgrid-table-header-sortable");g=f.children().not(".ui-pgrid-table-expander").mouseup(function(){a.resizing_header?
a.resizing_header=false:a.do_sort(b(this).prevAll().length)}).wrapInner(g).append(b("<span />").addClass("ui-icon"));a.pgrid_resize_cols&&g.addClass("ui-pgrid-table-header-resizeable").mousedown(function(d){var e=b(this),c=d.pageX-e.offset().left;if(c<4&&e.hasClass("ui-pgrid-table-expander")||c>3&&c<e.width()-4)return true;a.resizing_header=true;a.resizing_tempX=d.pageX;a.resizing_cur=c<4?e.prev().children(".ui-pgrid-table-header-text"):e.children(".ui-pgrid-table-header-text");return false});delete g;
a.pgrid_resize_cols&&a.pgrid_widget.mousemove(function(b){if(a.resizing_header){var e=a.resizing_cur.width()+b.pageX-a.resizing_tempX;if(e>0)a.resizing_tempX=b.pageX,a.resizing_cur.width(e)}}).mouseup(function(){a.resizing_header=false});f.addClass("ui-widget-header").prepend(b('<th class="ui-icon ui-pgrid-table-icon-hidden ui-pgrid-table-expander"><div style="width: 16px; visibility: hidden;">+</div></th>').click(function(b){var e=a.pgrid_widget.offset();a.pgrid_header_select.css({left:b.pageX-e.left-
5,top:b.pageY-e.top-5});a.pgrid_header_select.fadeIn("fast")}).mouseover(function(){b(this).removeClass("ui-pgrid-table-icon-hidden").addClass("ui-icon-triangle-1-s")}).mouseout(function(){b(this).addClass("ui-pgrid-table-icon-hidden").removeClass("ui-icon-triangle-1-s")}));delete f;a.init_rows(a.children("tbody").children());a.do_col_hiding(true);a.pgrid_table_viewport=b('<div class="ui-pgrid-table-viewport ui-widget-content" />');a.pgrid_table_container.appendTo(a.pgrid_table_viewport);a.pgrid_table_viewport.height(a.pgrid_view_height);
