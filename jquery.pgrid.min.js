...
!e.target&&a.pgrid_toolbar_target!="_self"||e.target&&e.target!="_self"?(d=e.target?e.target:a.pgrid_toolbar_target,e.window_features?window.open(f,d,e.window_features):window.open(f,d)):typeof $_!="undefined"&&$_.get?$_.get(f):window.location=f}return true});typeof e.title!="undefined"&&c.attr("title",e.title);if(e.double_click){if(a.pgrid_double_click_tb)var f=a.pgrid_double_click_tb;a.pgrid_double_click_tb=function(){f&&f();c.click()}}a.toolbar.append(c)}else if(e.type=="text"){var i=
