...
a.pgrid_double_click_tb=function(){i&&i();g.click()}}a.toolbar.append(g)}else if(d.type=="text"){b=c("<div />").addClass("ui-pgrid-toolbar-text");d.extra_class&&b.addClass(d.extra_class);typeof d.title!="undefined"&&b.attr("title",d.title);d.label&&b.append(c("<span>"+d.label+"</span>").addClass("ui-pgrid-toolbar-text-label"));var k=c('<input type="text" />').addClass("ui-widget ui-widget-content ui-corner-all");d.dont_prevent_default||k.keydown(function(j){j.keyCode==13&&j.preventDefault()});d.attributes&&
