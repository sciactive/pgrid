 ...
 */
(function(b){b.fn.pgrid_add=function(f,c){if(!f)return this;this.each(function(){if(this.pines_grid){var a=this.pines_grid,m="";b.each(f,function(){m+="<tr"+(typeof this.key!="undefined"?' title="'+String(this.key)+'"':"")+(typeof this.classes!="undefined"?' class="'+String(this.classes)+'"':"")+">";m+="<td>"+this.values.join("</td><td>")+"</td></tr>"});var g=a.children("tbody").detach(),j=b(m).appendTo(g);a.init_rows(j);a.do_col_hiding(true,j);a.do_sort(false,true,g);a.do_filter(false,true,g);a.append(g);
a.paginate(true);a.update_selected();c&&j.each(c)}});return this};b.fn.pgrid_delete=function(f){if(f)this.each(function(){var a=this.pines_grid;a&&(f.jquery?f.each(function(){a.mark_for_delete_recursively(b(this))}):b.each(f,function(){typeof this=="object"?a.mark_for_delete_recursively(b(this)):a.children("tbody").children("[title="+this+"]").each(function(){a.mark_for_delete_recursively(b(this))})}),a.delete_marked())});else{var c=this.closest("table.ui-pgrid-table").get(0);if(c)c=c.pines_grid;
if(!c)return this;this.each(function(){c.mark_for_delete_recursively(b(this))});c.delete_marked()}return this};b.fn.pgrid_export_rows=function(f){var c=[];f||(f=this);b.each(f,function(){var a=b(this),f=a.attr("title"),g=a.attr("class"),j=[];a.children().not(".ui-pgrid-table-expander").each(function(){j=b.merge(j,[b(this).text()])});c=b.merge(c,[{key:typeof f=="undefined"?"":f,classes:typeof g=="undefined"?"":g.replace(/\bui-[a-z0-9 \-]+/,""),values:j}])});return c};b.fn.pgrid_expand_rows=function(b){var c=
null;b?c=this.get(0):(b=this,c=b.closest(".ui-pgrid-table").get(0));if(c&&c.pines_grid)c=c.pines_grid;if(!c)return this;if(!b.jquery){if(typeof b!="object")return this;b=c.children("tbody").children("[title='"+b.join("'], [title='")+"']")}b=b.filter(".parent").addClass("ui-pgrid-table-row-expanded");c.show_children(b);return this};b.fn.pgrid_collapse_rows=function(b){var c=null;b?c=this.get(0):(b=this,c=b.closest(".ui-pgrid-table").get(0));if(c&&c.pines_grid)c=c.pines_grid;if(!c)return this;if(!b.jquery){if(typeof b!=
...
c.update_selected());return this};b.fn.pgrid_get_all_rows=function(){var b=false;this.each(function(){if(this.pines_grid.jquery){var c=this.pines_grid;b=b?b.add(c.children("tbody").children()):c.children("tbody").children()}});return b};b.fn.pgrid_get_selected_rows=function(){var b=false;this.each(function(){if(this.pines_grid.jquery){var c=this.pines_grid;b=b?b.add(c.children("tbody").children(".ui-pgrid-table-row-selected")):c.children("tbody").children(".ui-pgrid-table-row-selected")}});return b};
b.fn.pgrid_add_descendant_rows=function(){var f=b(this),c=null;if((c=f.closest("table.ui-pgrid-table").get(0))&&c.pines_grid)c=c.pines_grid;if(!c)return this;this.filter(".parent").each(function(){var a=b(this),a=a.siblings("."+c.pgrid_child_prefix+a.attr("title"));f=f.add(a.pgrid_add_descendant_rows())});return f};b.fn.pgrid_get_value=function(f){return b(this).eq(0).children(":nth-child("+(f+1)+")").html()};b.fn.pgrid_set_value=function(b,c){this.children(":nth-child("+(b+1)+")").html(c)};b.fn.pgrid_export_state=
function(){var b=this.get(0);if(b&&b.pines_grid)b=b.pines_grid;return b.jquery?b.export_state():false};b.fn.pgrid_import_state=function(b){this.each(function(){this.pines_grid&&this.pines_grid.import_state(b)});return this};b.fn.pgrid=function(f){var c=b.extend({},b.fn.pgrid.defaults,f);this.filter("table").not(".ui-pgrid-table").each(function(){var a=b(this);a.pgrid_version="1.2.0dev";a.extend(a,c);a.pgrid_pages=null;a.pgrid_widget=b("<div />");a.pgrid_table_container=b("<div />");a.pgrid_header_select=
b("<div />");a.wrapAll(a.pgrid_widget);a.pgrid_widget=a.parent();a.detach();a.pgrid_widget.addClass("ui-pgrid ui-widget ui-widget-content ui-corner-all");a.pgrid_table_container.addClass("ui-pgrid-table-container");a.pgrid_table_container.append(a);a.addClass("ui-pgrid-table");a.pgrid_select&&a.addClass("ui-pgrid-selectable");a.pgrid_toolbar_contents=a.pgrid_toolbar_contents.slice();a.pgrid_hidden_cols=a.pgrid_hidden_cols.slice();if(!a.pgrid_hidden_cols.indexOf)a.pgrid_hidden_cols.indexOf=function(a,
b){var c=this.length>>>0,h=Number(b)||0,h=h<0?Math.ceil(h):Math.floor(h);for(h<0&&(h+=c);h<c;h++)if(h in this&&this[h]===a)return h;return-1};a.export_state=function(){var b={pgrid_page:a.pgrid_page,pgrid_perpage:a.pgrid_perpage,pgrid_filter:a.pgrid_filter,pgrid_hidden_cols:a.pgrid_hidden_cols.slice(),pgrid_sort_col:a.pgrid_sort_col,pgrid_sort_ord:a.pgrid_sort_ord};if(a.pgrid_stateful_height)b.pgrid_view_height=a.pgrid_table_viewport.css("height");return b};a.import_state=function(b){if(typeof b.pgrid_page==
...
window.clearTimeout(a.paginate_timout);a.paginate_timout=window.setTimeout(a.paginate,50)};a.animate_filter=function(b){b?a.footer_input.stop(true).fadeTo(400,1):a.footer_input.fadeTo(1E3,0.7).fadeTo(1E3,0.8,a.animate_filter)};a.do_filter=function(b,e,c){if(a.pgrid_filtering||e){a.footer_input&&(a.footer_input.addClass("ui-state-highlight"),a.animate_filter());a.filter_timer&&window.clearInterval(a.filter_timer);if(typeof b=="string")a.pgrid_filter=b;if(a.pgrid_filter.length>0){var h=a.pgrid_filter.toLowerCase().split(" "),
f=0;c||(c=a.children("tbody"));var p=c.children();a.filter_timer=window.setInterval(function(){var b,d,c,k;do{b=p.eq(f);if(!b.length){window.clearInterval(a.filter_timer);a.footer_input&&(a.footer_input.removeClass("ui-state-highlight"),a.animate_filter(true));break}f++;d=b.get();d.pgrid_filter_text?c=d.pgrid_filter_text:(c=d.innerText!=void 0?d.innerText.toLowerCase():d.textContent!=void 0?d.textContent.toLowerCase():b.text().toLowerCase(),d.pgrid_filter_text=c);d=true;for(k in h)if(c.indexOf(h[k])==
-1){d=false;break}b.hasClass("ui-helper-hidden")?d&&b.removeClass("ui-helper-hidden"):d||b.addClass("ui-helper-hidden");d&&b.hasClass("child")&&a.enable_parents(b)}while(f%25);e||(a.paginate_queue(),a.update_selected_queue())},1)}else a.children("tbody").children(".ui-helper-hidden").removeClass("ui-helper-hidden"),a.footer_input&&(a.footer_input.removeClass("ui-state-highlight"),a.animate_filter(true)),e||(a.paginate(),a.update_selected())}};a.enable_parents=function(d){d.filter(".child").each(function(){var d=
...
d||c.children(":hidden").each(function(){var a=b(this).show();e.children(":nth-child("+(a.prevAll().length+1)+")").show()});var f=a.pgrid_header_select.children().children();f.attr("checked",true);for(var i in a.pgrid_hidden_cols)isNaN(i)||(f.filter(".ui-pgrid-table-col-hider-"+a.pgrid_hidden_cols[i]).removeAttr("checked"),c.children(":nth-child("+(a.pgrid_hidden_cols[i]+1)+")").hide(),e.children(":nth-child("+(a.pgrid_hidden_cols[i]+1)+")").hide());d||a.state_changed()};a.hide_col=function(b){a.pgrid_hidden_cols.indexOf(b)==
...
a.pgrid_double_click&&a.pgrid_double_click(d,a.children("tbody").children(".ui-pgrid-table-row-selected")),a.pgrid_double_click_tb&&a.pgrid_double_click_tb())}).delegate("tr","mousedown",function(a){return!(a.ctrlKey||a.shiftKey)});a.h_rows=a.children("thead").children();a.h_rows.children().each(function(d){var e=b(this);a.pgrid_header_select.append(b("<label></label>").addClass("ui-state-default ui-corner-all").append(b('<input type="checkbox" />').change(function(b){b.target.checked?a.show_col(d+
1):a.hide_col(d+1)}).addClass("ui-pgrid-table-col-hider-"+(d+1))).append(e.text()))});a.pgrid_header_select.addClass("ui-pgrid-header-select ui-widget-header ui-corner-all");a.pgrid_header_select.mouseenter(function(){b(this).mouseleave(function(){b(this).fadeOut("fast").unbind("mouseleave")})});a.resizing_header=false;a.resizing_tempX=0;var f=b("<div />").addClass("ui-pgrid-table-header-text");a.pgrid_sortable&&f.addClass("ui-pgrid-table-header-sortable");a.h_headers=a.h_rows.children().not(".ui-pgrid-table-expander").mouseup(function(){a.resizing_header?
a.resizing_header=false:a.do_sort(b(this).prevAll().length)}).wrapInner(f).append(b("<span />").addClass("ui-icon"));a.pgrid_resize_cols&&a.h_headers.addClass("ui-pgrid-table-header-resizeable").mousedown(function(d){var e=b(this),c=d.pageX-e.offset().left;if(c<4&&e.hasClass("ui-pgrid-table-expander")||c>3&&c<e.width()-4)return true;a.resizing_header=true;a.resizing_tempX=d.pageX;a.resizing_cur=c<4?e.prev().children(".ui-pgrid-table-header-text"):e.children(".ui-pgrid-table-header-text");return false});
delete a.h_headers;a.pgrid_resize_cols&&a.pgrid_widget.mousemove(function(b){if(a.resizing_header){var e=a.resizing_cur.width()+b.pageX-a.resizing_tempX;if(e>0)a.resizing_tempX=b.pageX,a.resizing_cur.width(e)}}).mouseup(function(){a.resizing_header=false});a.h_rows.addClass("ui-widget-header").prepend(b('<th class="ui-icon ui-pgrid-table-icon-hidden ui-pgrid-table-expander"><div style="width: 16px; visibility: hidden;">+</div></th>').click(function(b){var e=a.pgrid_widget.offset();a.pgrid_header_select.css({left:b.pageX-
e.left-5,top:b.pageY-e.top-5});a.pgrid_header_select.fadeIn("fast")}).mouseover(function(){b(this).removeClass("ui-pgrid-table-icon-hidden").addClass("ui-icon-triangle-1-s")}).mouseout(function(){b(this).addClass("ui-pgrid-table-icon-hidden").removeClass("ui-icon-triangle-1-s")}));delete a.h_rows;a.init_rows(a.children("tbody").children());a.do_col_hiding(true);a.pgrid_table_viewport=b('<div class="ui-pgrid-table-viewport ui-widget-content" />');a.pgrid_table_container.appendTo(a.pgrid_table_viewport);
a.pgrid_table_viewport.height(a.pgrid_view_height);a.pgrid_view_height!="auto"&&a.pgrid_table_container.css({position:"absolute",top:"0",bottom:"0",left:"0",right:"0"});if(a.pgrid_toolbar)a.toolbar=b("<div />").addClass("ui-pgrid-toolbar").delegate("button","focus",function(){b(this).addClass("ui-state-focus")}).delegate("button","blur",function(){b(this).removeClass("ui-state-focus ui-state-active")}).delegate("button","mousedown",function(){b(this).addClass("ui-state-active")}).delegate("button",
"mouseup",function(){b(this).removeClass("ui-state-active")}).delegate("button","mouseenter",function(){b(this).addClass("ui-state-hover")}).delegate("button","mouseleave",function(){b(this).removeClass("ui-state-hover")}),b.each(a.pgrid_toolbar_contents,function(d,e){if(e.type=="button"){var c=b('<button class="ui-pgrid-toolbar-button ui-state-default ui-corner-all" type="button" />').append(b(typeof e.text=="undefined"?"<span></span>":"<span>"+e.text+"</span>").each(function(){e.extra_class&&b(this).addClass(e.extra_class)})).click(function(d){if(d.button==
2)return true;var c=e.return_all_rows?a.children("tbody").children().not(".ui-helper-hidden"):a.children("tbody").children(".ui-pgrid-table-row-selected");if(!e.selection_optional&&!e.select_all&&!e.select_none&&c.length===0)return alert("Please make a selection before performing this operation."),false;if(!e.multi_select&&!e.selection_optional&&!e.select_all&&!e.select_none&&c.length>1)return alert("Please choose only one item before performing this operation."),false;if(e.confirm)if(typeof e.confirm==
"function"){if(!e.confirm(d,c))return false}else{var f="";typeof e.text!="undefined"?f=' "'+e.text+'"':typeof e.title!="undefined"&&(f=' "'+e.title+'"');if(e.return_all_rows){if(!confirm("Are you sure you want to perform the operation"+f+" on all items?"))return false}else if(c.length===0){if(!confirm("Are you sure you want to perform the operation"+f+"?"))return false}else if(!confirm("Are you sure you want to perform the operation"+f+" on the "+c.length+" currently selected item(s)?"))return false}e.select_all&&
a.pgrid_select&&a.pgrid_multi_select&&(a.children("tbody").children().not(".ui-helper-hidden").addClass("ui-pgrid-table-row-selected ui-state-active"),a.update_selected());e.select_none&&a.pgrid_select&&(a.children("tbody").children().removeClass("ui-pgrid-table-row-selected ui-state-active"),a.update_selected());if(e.click){var g="";e.pass_csv||e.pass_csv_with_headers?(e.pass_csv_with_headers&&(c=a.children("thead").children().add(c)),c.each(function(){b(this).children().not(".ui-pgrid-table-expander").each(function(){var a=
b(this);g+='"'+a.contents().text().replace(/"/g,'""')+'"';a.next()&&(g+=",")});g+="\n"})):g=c;return e.click(d,g)}else if(e.url){var f=e.url,i="",h=[];c.each(function(){var a=b(this),d=a.children().not(".ui-pgrid-table-expander");i+=(i.length?e.delimiter:"")+n(a.attr("title"));d.each(function(a){h[a+1]?h[a+1]+=e.delimiter+n(b(this).contents().text()):h[a+1]=n(b(this).contents().text())})});var f=f.replace("__title__",i),j;for(j in h)isNaN(j)||(f=f.replace("__col_"+j+"__",h[j]));return d.button==1||
!e.target&&a.pgrid_toolbar_target!="_self"||e.target&&e.target!="_self"?(d=e.target?e.target:a.pgrid_toolbar_target,e.window_features?window.open(f,d,e.window_features):window.open(f,d)):typeof pines!="undefined"&&pines.get?pines.get(f):window.location=f}return true});typeof e.title!="undefined"&&c.attr("title",e.title);if(e.double_click){if(a.pgrid_double_click_tb)var f=a.pgrid_double_click_tb;a.pgrid_double_click_tb=function(){f&&f();c.click()}}a.toolbar.append(c)}else if(e.type=="text"){var i=
b("<div />").addClass("ui-pgrid-toolbar-text");e.extra_class&&i.addClass(e.extra_class);typeof e.title!="undefined"&&i.attr("title",e.title);e.label&&i.append(b("<span>"+e.label+"</span>").addClass("ui-pgrid-toolbar-text-label"));var g=b('<input type="text" />').addClass("ui-widget ui-widget-content ui-corner-all");e.dont_prevent_default||g.keydown(function(a){a.keyCode==13&&a.preventDefault()});e.attributes&&g.attr(e.attributes);i.append(g);a.toolbar.append(i);e.load&&e.load(g)}else e.type=="label"?
(i=b("<div>"+e.label+"</div>").addClass("ui-pgrid-toolbar-label"),e.extra_class&&i.addClass(e.extra_class),typeof e.title!="undefined"&&i.attr("title",e.title),a.toolbar.append(i),e.load&&e.load(i)):e.type=="separator"&&a.toolbar.append(b("<div />").addClass("ui-pgrid-toolbar-sep ui-state-default").append(b("<div>-</div>").addClass("ui-pgrid-toolbar-blank")))});if(a.pgrid_footer&&(a.footer=b("<div />").addClass("ui-pgrid-footer ui-widget-header ui-corner-bottom ui-helper-clearfix").delegate("button",
